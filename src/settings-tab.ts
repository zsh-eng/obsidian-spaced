...
export class SpacedSettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        new Setting(this.containerEl)
            ...
            .setDesc(
                "The padding that should be left around the inside of custom frame panes, in pixels."
            )
            .addText((t) => {
        ...
        for (let frame of this.plugin.settings.frames) {
            let heading = this.containerEl.createEl("h3", {
                text: frame.displayName || "Unnamed Frame",
            });
            let toggle = new ButtonComponent(this.containerEl)
                ...
                .onClick(async () => {
                    ...
                    toggle.setButtonText(
                        content.hidden ? "Show Settings" : "Hide Settings"
                    );
                });
            ...
            new Setting(content)
                ...
                .setDesc(
                    createFragment((f) => {
                        f.createSpan({
                            text: "The icon that this frame's pane should have. The names of any ",
                        });
                        f.createEl("a", {
                            text: "Lucide icons",
            ...
            new Setting(content)
                ...
                .setDesc(
                    "Custom Frames is a lot more restricted on mobile devices and doesn't allow for the same types of content to be displayed. If a frame doesn't work as expected on mobile, it can be disabled."
                )
                .addToggle((t) => {
            ...
            new Setting(content)
                ...
                .setDesc(
                    "Whether a button to open this frame should be added to the ribbon."
                )
                .addToggle((t) => {
            ...
            new Setting(content)
                ...
                .setDesc(
                    "Whether this frame should be opened in the unpinned center editor rather than one of the panes on the side. This is useful for sites that don't work well in a narrow view, or sites that don't require a note to be open when viewed."
                )
                .addToggle((t) => {
            ...
            new Setting(content)
                ...
                .setDesc(
                    createFragment((f) => {
                        f.createSpan({
                            text: "Whether this frame should use iframes on desktop as opposed to Electron webviews.",
                        });
                        f.createEl("br");
                        f.createEl("em", {
                            text: "Only enable this setting if the frame is causing issues or frequent crashes. This setting causes all Desktop-only settings to be ignored.",
                        });
                    })
                )
                .addToggle((t) => {
            ...
            new Setting(content)
                .setName("Page Zoom")
                .setDesc(
                    "The zoom that this frame's page should be displayed with, as a percentage."
                )
                .addText((t) => {
                    t.inputEl.type = "number";
            ...
            new Setting(content)
                ...
                .setDesc(
                    createFragment((f) => {
                        f.createSpan({
                            text: "A snippet of additional CSS that should be applied to this frame.",
                        });
                        f.createEl("br");
                        f.createEl("em", {
                            text: "Note that this is only applied on Desktop.",
                        });
                    })
                )
                .addTextArea((t) => {
            ...
            new Setting(content)
                ...
                .setDesc(
                    createFragment((f) => {
                        f.createSpan({
                            text: "A snippet of additional JavaScript that should be applied to this frame.",
                        });
                        f.createEl("br");
                        f.createEl("em", {
                            text: "Note that this is only applied on Desktop.",
        ...
        this.containerEl.createEl("p", {
            text: 'Create a new frame, either from a preset shipped with the plugin, or a custom one that you can edit yourself. Each frame\'s pane can be opened using the "Custom Frames: Open" command.',
        });
        ...
        disclaimer.createSpan({
            text: "Please be advised that, when adding a site as a custom frame, you potentially expose personal information you enter to other plugins you have installed. For more information, see ",
        });
